<div align="center">
  <img src="nanobot_logo.png" alt="BiomeClaw" width="500">
  <h1>BiomeClaw: Personal Health Companion</h1>
  <p>
...
**BiomeClaw** is a health-focused fork of [nanobot](https://github.com/HKUDS/nanobot), aimed at a more personal hosted companion experience.

This repo intentionally keeps the internal package, CLI, config path, and `NANOBOT_*` environment surface on `nanobot` for first-release runtime compatibility.

⚡️ It still inherits the upstream lightweight runtime and core-agent philosophy.
...
> 🐈 BiomeClaw is a fork of nanobot for educational, research, and technical exchange purposes only. It is unrelated to crypto and does not involve any official token or coin.

## Key Features of BiomeClaw:
...
> The public product name is **BiomeClaw**, but the current compatibility CLI remains `nanobot`.

**Install from source** (latest features, experimental changes may land here first; recommended for development)

```bash
git clone https://github.com/<your-account>/biomeclaw.git
cd biomeclaw
pip install -e .
```
